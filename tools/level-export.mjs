...
import { AMMO_BY_ID, MATERIALS, PIGS, SHAPES } from '../data.js?v=20260902-1';
import { decode, encode, settleTest, validate } from '../build.js?v=20260902-1';
import { EPISODES, LEVELS } from '../levels.js?v=20260902-1';

import { BUDGET, CARDS, CARDS_BY_ID, MATERIALS, PIGS, SHAPES, TUNE } from './data.js?v=20260902-2';
import { fromDegrees, makeWorld, maxPenetration, raycast } from './physics.js?v=20260902-2';
import { BLUEPRINT_VERSION, PIG_FLAG_DECOY, PIG_FLAG_FLAK, PIG_FLAGS,
  blockRayDepth, blueprintFromLevel, instantiate, makeRound, stepRound } from './sim.js?v=20260902-2';
